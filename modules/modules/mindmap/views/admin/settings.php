...
<div class="form-group">
    ...
    <div class="radio radio-primary radio-inline">
        <input type="radio" id="y_opt_1_mindmap_group" name="settings[staff_members_create_inline_mindmap_group]" value="1" <?= ($enabled == '1') ? ' checked' : '' ?>>
        <label for="y_opt_1_mindmap_group"><?php echo _l('settings_yes'); ?></label>
    </div>
    <div class="radio radio-primary radio-inline">
        <input type="radio" id="y_opt_2_mindmap_group" name="settings[staff_members_create_inline_mindmap_group]" value="0" <?= ($enabled == '0') ? ' checked' : '' ?>>
