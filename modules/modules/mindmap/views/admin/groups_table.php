...
$sIndexColumn = 'id';
$sTable       = db_prefix().'mindmap_groups';
...
foreach ($rResult as $aRow) {
    ...
    $options = icon_btn('mindmap/group/' . $aRow['id'], 'pencil-square-o', 'btn-default', [
        'onclick' => 'edit_group(this,' . $aRow['id'] . '); return false', 'data-name' => $aRow['name'], 'data-description' => $aRow['description'],
    ]);
    $row[] = $options .= icon_btn('mindmap/delete_group/' . $aRow['id'], 'remove', 'btn-danger _delete');
