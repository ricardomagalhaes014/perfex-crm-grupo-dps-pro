...
/*
Module Name: Purchase | Gestão de Compra
Description: Módulo de Gestão de Compras é uma ferramenta para gerenciar suas compras do dia a dia. Ele vem com todos os recursos necessários para qualquer empresa, que precisa comprar matéria-prima para fabricação ou produtos acabados para comercialização.
Version: 1.3.0
