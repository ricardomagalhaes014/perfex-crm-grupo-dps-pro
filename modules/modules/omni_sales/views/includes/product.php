...
<div class="row dflex">
  ...
  <div class="col-sm-8">
    ...
    <div class="position-relative pull-right">
      ...
      <li>
        <a href="#" data-id="<?php echo html_entity_decode($id); ?>" data-popup-open="popup-1"  class="btn btn-success pull-right display-block" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo _l("sync_products_from_store") ?>"><i class="fa fa-forward"></i><?php echo ' '._l('product'); ?></a>
      </li>
    </ul>
  </div>
  ...
  <div class="popup-inner">
   <div class="popup-scroll">
    <div class="col-md-12">
      ...
      <?php 
      $selected = '';
      echo render_select('omni_warehouse',$omni_warehouse,array('warehouse_id',array('warehouse_name')),'choose_the_warehouse',$selected,array()); 
      ?>
      <div class="form-group"><span class="red"><?php echo _l('please_choose_the_warehouse')?></span></div>
    </div>
