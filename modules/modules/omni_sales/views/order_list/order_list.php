 ...
 <div class="content">
   <div class="panel_s">
    <div class="panel-body">
     ...
     <div class="row"> 
      <div class="col-md-3"> 
        <a class="btn btn-primary" href="<?php echo admin_url('omni_sales/order_manual'); ?>">
      ...
      <div class="col-md-3">
        <div class="form-group">
          ...
          <select class="selectpicker display-block" data-width="100%" name="status" data-none-selected-text="<?php echo _l('no_status'); ?>" data-live-search="true">
            ...
            <option value="4"><?php echo _l('omni_shipping');?></option>
            <option value="5"><?php echo _l('finish');?></option>
            <option value="6"><?php echo _l('refund');?></option>
            <option value="7"><?php echo _l('lie');?></option>
            <option value="8"><?php echo _l('cancelled');?></option>
          </select>
        </div>
      </div>
