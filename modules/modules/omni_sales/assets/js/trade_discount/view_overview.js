...
function total_cart(){
  "use strict"; 
    ...
    // console.log(parseFloat(get_discount_client(sub_total)));
    // console.log(parseFloat(other_discount));
    // console.log(parseFloat(new_discount_voucher));
    // var discount = 2572.5*3;
