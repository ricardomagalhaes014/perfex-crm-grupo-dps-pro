                                                    ...
                                                    <div class="modal-dialog modal-confirm">
                                                        <div class="modal-content" style="margin-top:100px;">
                                                            <div class="modal-header">
                                                                ...
                                                                <h1 class="bold invoice-html-number" style="text-align: center;"><strong>O pagamento está em processamento.</strong></h1>
                                                            </div>
                                                            <div class="modal-body">
                                                                <p class="text-center">
                                                                    Você pode sair dessa página à vontade, todos os demais passos serão enviados no seu email (<span id="mostrar-email"></span>). Muito obrigado!
                                                                </p>
                                                            </div>
                                                                ...
                                                                <div class="container-credit-card">
                                                                    ...
                                                                    <div class="col2">
                                                                        <form id="form-cartao" method="post">
                                                                            ...
                                                                            <button class="buy btn-pagar">Pagar Agora</button>
                                                                        </form>
                                                                    </div>
                                                                </div>
                                                                                ...
                                                                                if (resposta.code == 200) {
                                                                                    ...
                                                                                    if (resposta.erro) {
                                                                                        ...
                                                                                        if (resposta.message == 'success') {
                                                                                            $('#myModal').modal('show');
                                                                                            // $('.btn-pagar').attr('disabled', true);
                                                                                            $('.buy').html('Em análise').attr('disabled', true);
                                                                                            $('.btn-pagar').remove();
                                                                                            $('#mostrar-email').text($('#email').val());
                                                                                            $('.invoice-status-1').addClass('label-warning')
                                                                                            .removeClass('label-danger ').text('Pagamento em processamento.');
                                                                                        } else {
                                                                                            $('.buy').html('Pagar agora').attr('disabled', false)
