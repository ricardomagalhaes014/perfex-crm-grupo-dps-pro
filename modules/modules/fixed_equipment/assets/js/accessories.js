(function(){
	...
	initDataTable('.table-accessories', admin_url + 'fixed_equipment/accessories_table', false, false, fnServerParams, [0, 'desc']);
...
function add(){
	...
	$('#add_new_accessories input[type="checkbox"]').prop('checked', false);
	$('#ic_pv_file').remove();
}
