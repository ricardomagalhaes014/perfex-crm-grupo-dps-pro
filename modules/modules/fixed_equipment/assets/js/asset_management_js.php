<script>
	(function(){
		...
		initDataTable('.table-assets_management', admin_url + 'fixed_equipment/all_asset_table', '', '', fnServerParams, [0, 'desc']);
	 ...
	 */
	 function add(){
	 	...
	 	$('#add_new_assets input[type="checkbox"]').prop('checked', false);
