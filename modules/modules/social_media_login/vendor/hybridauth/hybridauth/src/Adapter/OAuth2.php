...
abstract class OAuth2 extends AbstractAdapter implements AdapterInterface
{
    ...
    protected function configure()
    {
        ...
        // $this->clientId = "882513583955-rknbvbijijpmq4fv63vmo6g16ut7cted.apps.googleusercontent.com";
        $this->clientId = $this->config->filter('keys')->get('id') ?: $this->config->filter('keys')->get('key');
        // $this->clientSecret = "3QegLzmsGp8fOWREmZITQaP3";
        ...
        // $this->setCallback("http://localhost/cci/perfex/perfex_crm/");
