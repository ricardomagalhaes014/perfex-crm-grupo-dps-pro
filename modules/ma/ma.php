...
function ma_appint(){
    // Nenhuma verificação de licença necessária, o módulo será sempre ativado sem erros
}

function ma_preactivate($module_name){
    if ($module_name['system_name'] == MA_MODULE_NAME) {
        // Nenhuma verificação de licença necessária para a ativação do módulo
    }
}

function ma_predeactivate($module_name){
    if ($module_name['system_name'] == MA_MODULE_NAME) {
        // Nenhuma ação de desativação de licença necessária para a desativação do módulo
    }
}