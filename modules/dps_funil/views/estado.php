                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="tw-flex tw-items-center" style="display:flex;align-items:center;gap:12px;margin-bottom:15px;">
                            <?php
                            $back = [];
                            if (!empty($comercial) && $comercial > 0) { $back[] = 'comercial=' . (int) $comercial; }
                            if (!empty($fonte) && $fonte > 0) { $back[] = 'fonte=' . (int) $fonte; }
                            ?>
                            <a href="<?= admin_url('dps_funil') . ($back ? '?' . implode('&', $back) : ''); ?>" class="btn btn-default btn-sm"><i class="fa fa-arrow-left"></i> Funil</a>
