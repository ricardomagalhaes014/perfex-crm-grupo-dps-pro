...
/*
Module Name: Advanced task status manager | Gerenciador avançado de status de tarefas
Description: Módulo para gerenciamento avançado de status
Version: 1.1.0
Author: Image Design | Grupo Liquida I.A no Telegram
...
function load_project_statuses_from_db($statuses)
{
    ...
    if (!isset($CI->project_status_once)) { $CI->project_status_once = false; }
