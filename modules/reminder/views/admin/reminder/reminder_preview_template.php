   ...
   <div class="row">
     <div class="form-group col-md-6">
       <div class="checkbox checkbox-primary">
         <?php $checked = isset($reminder) && $reminder->notify_by_sms_client=='2' ? 'checked' : ''; ?>
         <input type="checkbox" name="notify_by_sms_client" id="notify_by_sms_client" <?php echo $checked; ?>>
     ...
     <div class="form-group col-md-6">
      <div class="checkbox checkbox-primary">
         <?php $checked = isset($reminder) && $reminder->notify_by_email_client=='2' ? 'checked' : ''; ?>
        <input type="checkbox" name="notify_by_email_client" id="notify_by_email_client" <?php echo $checked; ?>>
