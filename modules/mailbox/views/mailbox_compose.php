...
<div class="row">
  <div class="col-md-12">
    ...
    <?php
        ...
        $subject = '';
        $body    = '';
        $outbox_id = ''; // Inicializando a variável
    ?>
    <?php if (isset($mail)) {
        $to      = $mail->to;
        $cc      = $mail->cc;
        ...
        $body    = $mail->body;
        $outbox_id = isset($mail->outbox_id) ? $mail->outbox_id : ''; // Verificando se $mail tem a propriedade outbox_id
    }
    ?>
    ...
    <div class="pull-right">   
      ...
      <?php } ?>
      <?php if (isset($outbox_id) && $outbox_id !== '') {?>
