...
class Googlecalendar extends App_Model
{
    ...
    protected string $unauthorized_url_settings;

   public function __construct()
{
    parent::__construct();

    // Carrega e instancia corretamente a biblioteca Googleplus
    $this->load->library('appointly/googleplus');
    $this->googleplus = new Googleplus(); // Instancia manualmente para evitar erro de propriedade não inicializada

    // Mensagem de erro caso falhe a autenticação
    ...
    // Configurações padrão de lembrete do Google Calendar
    ...
    // Instância do serviço do Google Calendar
