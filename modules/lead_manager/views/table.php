...
$staffs    = $this->ci->staff_model->get('', ['active' => 1]); // staff ativos
...
// ========================
// Adiciona regra "Atribuído a" no Criar Filtro
// ========================
$assignedOptions = [];
foreach ($staffs as $s) {
    $assignedOptions[] = [
...
App_table::rule('leads',
    App_table_filter::new('assigned', 'SelectRule')
        ->label(_l('assigned'))
...
// [... resto do foreach $rResult igual ao teu código ...]
