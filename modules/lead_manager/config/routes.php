...
//$route['lead_manager/apis/(:any)'] = 'apis/$1';
...
/*
| -------------------------------------------------------------------------
| Lead Manager API Routes
| -------------------------------------------------------------------------
| These routes connect API requests to the correct controllers.
| Example: https://crm.grupo-dps.com/lead_manager/apis/leads
*/
$route['lead_manager/apis/(:any)/(:num)'] = 'apis/$1/$2';
$route['lead_manager/apis/(:any)'] = 'apis/$1';
