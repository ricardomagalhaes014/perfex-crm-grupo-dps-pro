            ...
            <div role="tabpanel"
                ...
                <div class="row">
                    ...
                    <div
                        ...
                        <?php if (isset($client) && !empty($client->phonenumber)) { 
    $phoneClean = preg_replace('/\D+/', '', $client->phonenumber); // só números
?>
    <p>
        <i class="fa fa-phone"></i>
        <a href="tel:<?= e($client->phonenumber); ?>">
...
<?php if (isset($client)) { ?>
<?php if (is_staff_logged_in()) { // permitir a todos os staff ?>
