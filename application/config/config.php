...
$config['csrf_exclude_uris'] = ['forms/wtl/[0-9a-z]+', 'forms/ticket', 'forms/quote/[0-9a-z]+', 'admin/tasks/timer_tracking', 'admin/tasks/add_task_comment', 'api\/.+', 'razorpay/success\/.+'];
